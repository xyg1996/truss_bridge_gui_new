...
class Ui_Workspace(QWidget):
    ...
    def setupUI(self, Form):
        ...
        self.tab0 = QWidget(self.tabWidget_2)
        self.tab1 = QWidget(self.tabWidget_2)
        self.tab2 = QWidget(self.tabWidget_2)
        self.tab3 = QWidget(self.tabWidget_2)
        self.tab4 = QWidget(self.tabWidget_2)
        ...
        self.pic_path =  '/share/simforge_share/usr-release/SALOME-9.4.0-CO7-SRC/INSTALL/ASTERSTUDY/lib/python3.6/site-packages/asterstudy/gui/truss_bridge'

...
class Main(QWidget):
    ...
    def __init__(self,input):
        ...
        self.curr_dir = '/share/simforge_share/usr-release/SALOME-9.4.0-CO7-SRC/BINARIES-CO7/ASTERSTUDY/lib/python3.6/site-packages/asterstudy/gui/truss_bridge'
        self.curr_dir_2 = '/amd_share/online1/install/truss_bridge/SALOME-9.4.0-CO7-SRC/asterstudy/gui'
        self.work_dir = '/share/simforge_share/usr-release/SALOME-9.4.0-CO7-SRC/BINARIES-CO7/ASTERSTUDY/lib/python3.6/site-packages/asterstudy/gui/truss_bridge'
        #print(self.work_dir)
        #self.astergui = astergui
        self.meshview = input
